...
Attributes range from 'Alien Attack' to 'Yo Mama- jokes! (Magic Dice gives extended attributes)', with points reflecting the rarity or commonality of the attribute.
